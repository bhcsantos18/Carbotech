...
const NodesList: React.FC = () => {
  const bubbles = [
    ...
    },
    {
      ...
      label: 'HTTP Request',
      iconType: 'http',
      description: 'Integração com APIs e Webhooks',
    ...
    },
    {
      ...
      label: 'Atendente IA',
      iconType: 'ai',
      description: 'Integração com Atendente IA',
      category: 'integrations'
    }
  ];
  ...
  const integrationBubbles = bubbles.filter(b => b.category === 'integrations');
  ...
  return (
    <div className="p-4 space-y-6">
      ...
      {/* Integrações */}
      <div>
        <h3 className="text-sm font-medium text-gray-900 mb-4">Integrações</h3>
        <div className="space-y-2">
